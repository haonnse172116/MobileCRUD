...
import object.OrderDAO;
import object.OrderDTO;
...
public class SaveCartController extends HttpServlet {
    ...
    private static final String ERROR = "mobileCart.jsp";
    private static final String SUCCESS = "mobileCart.jsp";
        ...
        try {
            ...
            if (cart != null && userId != null) {
                ...
                if (checkInsert) {
                    ...
                    request.setAttribute("ERROR", "Error when saving");
                }
            }
        } catch (Exception e) {
            log("Error at SaveCartController: " + e.toString());
        } finally {
